...
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --output=/scratch/general/vast/u1475870/photonode/logs/%j/%j_inference.out
...
cp -f /uufs/chpc.utah.edu/common/home/$USER/photonode/inference.py .
...
if [ $? -eq 0 ]; then
    ...
    # Copy results back
    OUTPUT_DIR="/uufs/chpc.utah.edu/common/home/$USER/photonode/outputs/inference_results"
    mkdir -p $OUTPUT_DIR
